...
import 'package:clean_architecture/feature/freight_oner_module/freight/presentation/screen/freight_detail_page.dart';
...
import 'package:clean_architecture/feature/freight_oner_module/my_loads/presentation/bloc/my_loads_state.dart';
import 'package:clean_architecture/feature/freight_oner_module/my_loads/presentation/model/load_view_model.dart';
        ...
        child: ClipRRect(
          ...
          child: Column(
            children: [
              ...
              // Pay Now button — only shown for BOOKED loads
              if (vm.status == LoadStatus.booked)
                Container(
                  ...
                  child: ElevatedButton.icon(
                    onPressed: () => Navigator.pushNamed(
                      ...
                      arguments: {
                        'bookingType': 'AUTO',
                        'sourceId': vm.freightId,
                        'totalAmount': vm.rawAmount,
                        'freightRoute': '${vm.pickupCity} → ${vm.dropoffCity}',
                      },
                    ),
                    icon: const Icon(
                      Icons.payment,
