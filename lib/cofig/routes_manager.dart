...
import 'package:clean_architecture/feature/payment/presentation/screen/payment_history_screen.dart';
  ...
  static Route<dynamic> getRoute(RouteSettings routeSettings) {
    switch (routeSettings.name) {
      ...
      case Routes.carrierUserDetail:
        final owner = routeSettings.arguments as TruckOwnerEntity?;
        return MaterialPageRoute(
          builder: (_) => CarrierUserDetail(owner: owner),
        );

      case Routes.viewAllReiviews:
        final ownerId = routeSettings.arguments as String?;
        return MaterialPageRoute(
          builder: (_) => CarrierUserReviewAll(ownerId: ownerId),
        );
